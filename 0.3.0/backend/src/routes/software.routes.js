...
router.get('/export', software_controller_1.softwareController.exportData); // Експорт JSON
router.post('/import', software_controller_1.softwareController.importData); // Імпорт JSON
router.get('/summary', software_controller_1.softwareController.summary); // Aggregation
router.get('/search', software_controller_1.softwareController.searchUnsafe); // Unsafe search (SQLi demo)
